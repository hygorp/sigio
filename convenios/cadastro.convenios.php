    ...
    <form class="ui form cadastro-convenios-form" method="POST">
        ...
        <div class="three fields">
            <div class="three wide field">
                <label>CEP</label>
                <input type="text" class="cep" name="cep_convenios" placeholder="CEP">
            </div>
            
            <div class="eight wide field">
                <label>Endereço</label>
                <input type="text" name="endereco_convenios" placeholder="Endereço">
            </div>
            
            <div class="eight wide field">
                <label>Complemento</label>
                <input type="text" name="complemento_convenios" placeholder="Complemento">
            </div>
        </div>
        ...
        <div class="four fields">
            <div class="six wide field">
                <label>Bairro</label>
                <input type="text" name="bairro_convenios" placeholder="Bairro">
            </div>
            
            <div class="six wide field">
                <label>Cidade</label>
                <input type="text" name="cidade_convenios" placeholder="Cidade">
            </div>
            
            <div class="two wide field">
                <label>UF</label>
                <input type="text" name="uf_convenios" placeholder="UF">
            </div>
            
            <div class="four wide field">
                <label>País</label>
                <input type="text" name="pais_convenios" placeholder="País">
            </div>
        </div>
        ...
        <div class="two fields">
            <div class="seven wide field">
                ...
                <input type="text" name="nome_representante_convenios" placeholder="ex: representante@gmail.com">
            </div>
