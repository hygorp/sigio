$(function(){
    ...
    $('.ui.form.cadastro-pacientes-form').form({
        ...
        fields: {
           ...
           email_pacientes: {
               identifier: 'email_pacientes',
               rules: [{
                    type: 'email',
                    prompt: 'Este não é um Email válido'
               }]
           },
    ...
    $('.ui.form.cadastro-laboratorios-form').form({
        keyboardShortcuts: false,
        fields: {
           razao_social_laboratorios: {
               identifier: 'razao_social_laboratorios',
               rules: [{
                    type: 'empty',
                    prompt: 'Preencha o campo Razão Social'
               }]
           },
           nome_fantasia_laboratorios: {
               identifier: 'nome_fantasia_laboratorios',
               rules: [{
                    type: 'empty',
                    prompt: 'Preencha o campo Nome Fantasia'
               }]
           },
           inscricao_estadual_laboratorios: {
               identifier: 'inscricao_estadual_laboratorios',
               rules: [{
                    type: 'empty',
                    prompt: 'Preencha o campo Inscrição Estadual'
               }]
           ...
           cnpj_laboratorios: {
               identifier: 'cnpj_laboratorios',
               rules: [{
                    type: 'empty',
                    prompt: 'Preencha o campo CNPJ'
               }]
           },
           atuacao_laboratorios: {
               identifier: 'atuacao_laboratorios',
               rules: [{
                    type: 'empty',
                    prompt: 'Preencha o campo Áre de Atuação'
               }]
           },
           endereco_laboratorios: {
               identifier: 'endereco_laboratorios',
               rules: [{
                    type: 'empty',
                    prompt: 'Preencha o campo Endereço'
               }]
           },
           complemento_laboratorios: {
               identifier: 'complemento_laboratorios',
               rules: [{
                    type: 'empty',
                    prompt: 'Preencha o campo Complemento'
               }]
           ...
           bairro_laboratorios: {
               identifier: 'bairro_laboratorios',
               rules: [{
                    type: 'empty',
                    prompt: 'Preencha o campo Bairro'
               }]
           ...
           cidade_laboratorios: {
               identifier: 'cidade_laboratorios',
               rules: [{
                    type: 'empty',
                    prompt: 'Preencha o Cidade'
               }]
           ...
           pais_laboratorios: {
               identifier: 'pais_laboratorios',
               rules: [{
                    type: 'empty',
                    prompt: 'Preencha o campo País'
               }]
           },
           telefone_laboratorios: {
               identifier: 'telefone_laboratorios',
               rules: [{
                    type: 'empty',
                    prompt: 'Preencha o primeiro campo Telefone'
               }]
